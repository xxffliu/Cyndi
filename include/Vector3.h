...
public :
    ...
    {
           return double(v._vx*u._vx + v._vy*u._vy + v._vz*u._vz);
    };
    ...
    friend vector3 operator% (const vector3& v1, const vector3& v2){
           return vector3(v1._vy * v2._vz - v1._vz * v2._vy, v1._vz * v2._vx - v1._vx * v2._vz, v1._vx * v2._vy - v1._vy * v2._vx);
    };
    ...
    // calculate the distance between *this and vv
    inline double dist(const vector3 &vv) const
    {
           return sqrt(this->distSq(vv));
    }
...
// Calculate the minimial distance between 2 lines ab and cd
double MinDist_lines(vector3 a, vector3 c, vector3 b, vector3 d);

//  The global constant vector3s
extern const vector3 VZero;
extern const vector3 VUnit;
extern const vector3 VX;
extern const vector3 VY;
extern const vector3 VZ;

// a class to calculate the average of a serials of points
class Vector3Average: public std::binary_function<vector3, vector3, vector3>
{
public:
	Vector3Average():numPoints(0), vector3Sum(VZero){}
	const vector3 operator()(const vector3& avgSoFar, const vector3& p)
	{
		++numPoints;
		vector3Sum += p;
		return vector3Sum/numPoints;
	}
private:
	size_t numPoints;
	vector3 vector3Sum;
