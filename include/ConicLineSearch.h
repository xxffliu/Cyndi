	...
	class ConicLineSearch
	{
		public:
			...
			*/
			 ...
			 */
			void set_lower_bound(double lbound);
			 ...
			 */
			void set_bracketed_flag(bool bracktd);
			 ...
			 */
			void set_minimizer(EnergyMinimizer& minimizer);
			 ...
			 */
			virtual double take_step(double stp_lo, double f_lo, double g_lo,
